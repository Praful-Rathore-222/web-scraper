...
def scroll_to_bottom(driver):
    ...
    try:
        ...
        print(str(e))
        raise ValueError(
            """Took too long to scroll page.  Common problems/solutions:
                1. Slow Internet: increase the time out parameter in the Scraper
                   constructor
                """)
...
def scrap_profiles(driver):
    ...
    name = name[1:]
    Employee.objects.get_or_create(name=name.strip(),
...
def get_profile(profile, driver):
    ...
    try:
        ...
        print(str(e))
        raise ValueError(
            """Took too long to load profile links.  Common problems/solutions:
                    1. Slow Internet: increase the time out parameter in the Scraper
                       constructor
                    """)
